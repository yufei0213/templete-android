package com.unitedbustech.templete.excetion;
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    private final String LOG_PATH = "/storage/emulated/0/com.unitedbustech.templete/log/crash/";
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        ...
        if (!handleException(ex) && defaultHandler != null) {
            ...
            defaultHandler.uncaughtException(thread, ex); //如果用户没有处理则让系统默认的异常处理器来处理
        } else {
    ...
    private boolean handleException(Throwable ex) {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                Looper.prepare();
                Toast.makeText(context, "An unknown error occurred, is about to exit.", Toast.LENGTH_LONG).show();
                Looper.loop();
            }
        }.start();
